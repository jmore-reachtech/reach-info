...
$settings['services']['pidFiles'] = array(
	'Dropbear' => '/var/run/dropbear.pid',
	'nmbd' => '/var/run/nmbd.pid',
	'php-fpm' => '/var/run/php-fpm.pid',
	'SIO Agent' => '/var/run/sio_agent.pid',
	'TIO Agent' => '/var/run/tio_agent.pid',
	'Samba' => '/var/run/smbd.pid',
	'System Log' => '/var/run/syslogd.pid'
);
...
$settings['services']['executables'] = array(
	...
	'D-Bus' => '/usr/bin/dbus-daemon',
	'klog' => '/sbin/klogd',
	'QML Viewer' => './qml-viewer',
	'udhcpc' => 'udhcpc'
